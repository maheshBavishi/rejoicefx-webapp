...
import styles from './forexbrokerSetupHowitWork.module.scss';
...
const steps = [
    ...
    {
        id: 2,
        title: 'License & Legal Setup',
        description: 'We handle regulatory compliance and licensing',
    },
    {
        id: 3,
        title: 'Platform & CRM Deployment',
        description: 'We deploy and configure your trading platform and CRM',
    },
    {
        id: 4,
        title: 'Liquidity Integration',
        description: 'We integrate with top liquidity providers for seamless trading',
    },
    {
        id: 5,
        title: 'Testing & Go Live',
        description: 'We conduct thorough testing before launching your platform',
    },
];
export default function ForexbrokerSetupHowitWork() {
    return (
        <div className="container-lg">
            <div className={styles.forexbrokerSetupHowitWork}>
                <div className="container">
                    ...
                    <p>
                        Our copy trading platform streamlines the entire process with a seamless five-step workflow.
                    </p>
                    <div className={styles.grid}>
                        {steps.map((step, index) => (
                            <div className={styles.gridiitems} key={step.id}>
