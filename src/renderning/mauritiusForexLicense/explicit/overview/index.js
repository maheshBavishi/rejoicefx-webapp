            ...
            <div className="container">
                <div className={styles.grid}>
                    <div className={styles.griditems}>
                        ...
                        <p>
                            With GENXEL, you get total support for Mauritius FSC and Mauritius forex company formation process. Contact us if you want to know more about company formation process, registration fees, minimum capital requirements and Mauritius Forex License process as per Financial Services Act 2007.
                        </p>
                    </div>
                    <div className={styles.griditems}>
