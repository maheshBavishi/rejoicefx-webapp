            ...
            <div className="container">
                <div className={styles.grid}>
                    <div className={styles.griditems}>
                        ...
                        <p>
                            Mauritius offers amazing business experience with affordable capital requirements, fine banking services, payment service provider support, and easy application process for Mauritius forex license. The minimum paid-up capital requirement is MUR 700,000. Mauritius is the best destination for you, get a Mauritius Forex License!
                        </p>
                        <p>
                            With RejoiceFX, you get total support for Mauritius FSC and Mauritius forex company formation process. Contact us if you want to know more about company formation process, registration fees, minimum capital requirements and Mauritius Forex License process as per Financial Services Act 2007.
                        </p>
                    </div>
                    <div className={styles.griditems}>
                        <div className={styles.box}>
                            ...
                            <div className={styles.twoCol}>
                                ...
                                <div className={styles.input}>
                                    <label>Email Address <span>* {error?.email}</span></label>
