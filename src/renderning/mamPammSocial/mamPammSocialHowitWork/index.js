...
import styles from './mamPammSocialHowitWork.module.scss';
...
const steps = [
    {
        ...
        description: 'Manager creates and configures master trading account',
    },
    {
        id: 2,
        title: 'Investor Onboarding',
        description: 'Clients connect their accounts to the system',
    },
    {
        id: 3,
        title: 'Trade Execution',
        description: 'Manager executes trades from master account',
    },
    {
        id: 4,
        title: 'Allocation Process',
        description: 'Trades are distributed automatically based on selected method',
    },
    {
        id: 5,
        title: 'Profit Distribution',
        description: 'Profits and fees are calculated and distributed automatically',
    },
];

export default function MamPammSocialHowitWork() {
    return (
        <div className="container-lg">
            <div className={styles.workProcess}>
                <div className="container">
                    ...
                    <p>
                        Scale your brokerage and money management business with our seamless five-step process.
                    </p>
