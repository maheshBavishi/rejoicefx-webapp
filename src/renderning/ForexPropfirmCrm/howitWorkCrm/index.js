...
import styles from './howitWorkCrm.module.scss';
...
const steps = [
    {
        ...
        description: 'Configure your prop firm rules, branding, and models',
    },
    {
        id: 2,
        title: 'Trader Onboarding',
        description: 'Users register, complete KYC, and purchase challenges',
    },
    {
        id: 3,
        title: 'Trading Phase',
        description: 'Traders connect MT4/MT5 and start trading',
    },
    {
        id: 4,
        title: 'Evaluation',
        description: 'System automatically checks rules and performance',
    },
    {
        id: 5,
        title: 'Funding & Payouts',
        description: 'Successful traders get funded and receive payouts',
    },
];

export default function HowitWorkCrm() {
    return (
        <div className="container-lg">
            <div className={styles.workProcess}>
                <div className="container">
                    ...
                    <p>
                        Launch and manage your prop firm seamlessly with our automated five-step process.
                    </p>
