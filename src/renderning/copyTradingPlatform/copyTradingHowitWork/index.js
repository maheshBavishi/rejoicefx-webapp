...
import styles from './copyTradingHowitWork.module.scss';
import CommonButton from '@/components/commonButton';

const steps = [
    {
        id: 1,
        title: 'Register Traders & Investors',
        description: 'Users sign up and complete onboarding',
    },
    {
        id: 2,
        title: 'Choose Strategy Provider',
        description: 'Investors select traders based on performance',
    },
    {
        id: 3,
        title: 'Start Copy Trading',
        description: 'Trades are copied automatically in real time',
    },
    {
        id: 4,
        title: 'Track Performance',
        description: 'Users monitor profits, losses, and analytics',
    },
    {
        id: 5,
        title: 'Earn & Withdraw Profits',
        description: 'Automated profit sharing and withdrawals',
    },
];
export default function CopyTradingHowitWork() {
  return (
     <div className="container-lg">
            <div className={styles.workProcess}>
                <div className="container">
                    ...
                    <p>
                        Automate your copy trading business with our seamless five-step process.
                    </p>
