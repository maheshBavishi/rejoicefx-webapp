        ...
        <div>
            <div className="container-lg">
                <div className={styles.mauritiusForexLicenseBanner}>
                    ...
                    <p>
                        Grow your Forex business with <b>RejoiceFX Copy Trading Platform    </b>—a powerful solution that connects professional traders with investors. Enable seamless trade replication, performance tracking, and automated profit sharing with
