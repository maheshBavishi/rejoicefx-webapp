            ...
            <div className="container">
                <div className={styles.grid}>
                    <div className={styles.griditems}>
                        ...
                        <p>
                            At GENXEL, we deliver comprehensive forex technology solutions including company formation, broker licensing, web development, trader’s room setup, MT4/ MT5
