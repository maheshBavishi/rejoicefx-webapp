...
import styles from './vincentOverview.module.scss';
...
export default function VincentOverview() {
                ...
                <div className="container">
                    <div className={styles.grid}>
                        <div className={styles.griditems}>
                            ...
                            <p>
                                St. Vincent is recognized by the Organization for Economic Co-operation
                                and Development (OECD) as a stable, independent, and politically free island.
                            </p>
                        </div>
                        <div className={styles.griditems}>
